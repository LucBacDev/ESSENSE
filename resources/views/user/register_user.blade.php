                            ...
                            <div class="card-body p-4">
                                ...
                                <form method="post" action="">
                                    ...
                                    <div class="form-outline mb-2">
                                        ...
                                        <input type="number" class="form-control" name="phone" id="exampleFormControlTextarea1">
                                        @error('phone')
                                        <div class="alert alert-danger cl-red">{{ $message }}</div>
                                    @enderror
                                    </div>
                                    ...
                                    <div class="d-flex flex-column justify-content-center">
                                        <button type="submit"
                                            class="btn btn-success btn-block btn-lg gradient-custom-2 text-body">Đăng ký
                                        </button>
                                    </div>

                                    <p class="text-center text-muted mt-5 mb-0">Nếu bạn đã có tài khoản ?
                                        <a href="{{route('login')}}" class="fw-bold text-body"><u>Đăng nhập ở đây !</u></a>
                                    </p>
                                </form>
                            </div>
                        </div>
